...
public abstract class Value implements Serializable{
	...
	// -----------------------------------------------------------------------------------------
	protected int verifyRefreshedValue(Object originalValue, Object checkValue, Object newValue, int type) {
		return verifyRefreshedValue(originalValue, checkValue, newValue, type, 0);
	}
