...
public class ValueId implements Comparable<ValueId>, Serializable {
	...
	public ValueId(Node node, ValueGenre genre, byte cmdClassId, byte instance, byte valIdx, ValueType type) {
		this.node = node;
