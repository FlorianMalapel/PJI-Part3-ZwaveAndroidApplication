...
public class ValueManager extends ConcurrentHashMap<Integer, Value> {
	...
	public boolean removeValue(byte commandClassId, byte instance, byte valueIndex) {
		return removeValue(ValueId.getValueStoreKey(commandClassId, instance, valueIndex));
	}
	...
	public Value getValue(byte commandClassId, byte instance, byte valueIndex) {
		return getValue(ValueId.getValueStoreKey(commandClassId, instance, valueIndex));
	}
