...
public class QueueManager {
	...
	public boolean sendControllerCommand(ControllerCommand command, boolean highPower, byte nodeId) {
		return sendControllerCommand(command, controllerActionListener, null, highPower, nodeId, (byte) 0);
	}

	public boolean sendControllerCommand(ControllerCommand command, ControllerActionListener callback, Object context,
