...
public class SensorMultiLevel extends CommandClass {
	...
	public boolean requestState(int requestFlags, byte instance, QueuePriority queue) {
	...
	public boolean requestValue(int requestFlags, byte dummy1, byte instance, QueuePriority queue) {
		Msg msg = Msg.createZWaveApplicationCommandHandler(getNodeId(), COMMAND_CLASS_ID);
		msg.setInstance(this, instance);
		msg.appends(new byte[] { getNodeId(), 2, COMMAND_CLASS_ID, SENSOR_MULTI_LEVEL_CMD_GET,
