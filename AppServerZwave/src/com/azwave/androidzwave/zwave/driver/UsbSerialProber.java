...
/**
 * Helper class to assist in detecting and building {@link com.azwave.androidzwave.zwave.driver.UsbSerialDriver}
...
public enum UsbSerialProber {
    ...
    /**
     * Builds a new {@link com.azwave.androidzwave.zwave.driver.UsbSerialDriver} instance from the raw device, or
     ...
     * @return the first available {@link com.azwave.androidzwave.zwave.driver.UsbSerialDriver}, or {@code null} if
     ...
     *         no devices could be acquired
     */
    public static UsbSerialDriver acquire(final UsbManager usbManager, PendingIntent intent) {
        for (final UsbDevice usbDevice : usbManager.getDeviceList().values()) {
            final UsbSerialDriver probedDevice = acquire(usbManager, usbDevice, intent);
    ...
    /**
     * Builds and returns a new {@link com.azwave.androidzwave.zwave.driver.UsbSerialDriver} from the given
     ...
     * @return a new {@link com.azwave.androidzwave.zwave.driver.UsbSerialDriver}, or {@code null} if no devices
     *         could be acquired
     */
    public static UsbSerialDriver acquire(final UsbManager usbManager, final UsbDevice usbDevice, PendingIntent intent) {
